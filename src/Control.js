...
// import createCollectionFile from '../functions';
...
export default class RelationControl extends React.Component {
  ...
  handleFileSave = (value) => {
    ...
    const folder = config.collections.find(el => el.name === collectionName).folder;
      // createCollectionFile(folder,value,valueField)
  ...
  handleChange = selectedOption => {
    ...
    if (this.isMultiple()) {
      ...
      this.handleFileSave(last(value))
    } else {
